    ...
    <body>
        ...
        <main>
            ...
            <nav class="_header mw-100">
                ...
                <ul class="_navi">
                    <li class="_navi_ele"><a class="nav-link" aria-current="page" href="index.php?controller=homepageadmin&action=index">Trang chủ</a></li>
                    <li class="_navi_ele"><a class="nav-link" aria-current="page" href="index.php?controller=introadmin&action=index">Giới thiệu</a></li>
                    <li class="_navi_ele"><a class="nav-link" aria-current="page" href="index.php?controller=productadmin&action=index">Sản phẩm</a></li>
                    <li class="_navi_ele"><a class="nav-link" aria-current="page" href="index.php?controller=postadmin&action=index">Tin tức</a></li>
                    <li class="_navi_ele"><a class="nav-link" aria-current="page" href="index.php?controller=answerandquestionadmin&action=index">Hỏi đáp</a></li>
                    <li class="_navi_ele"><a class="nav-link" aria-current="page" href="index.php?controller=contactadmin&action=index">Liên hệ</a></li>
                ...
                <div class="_sidebar" id="sidebar">
                    ...
                    <div class="_sidebar-item"><a class="nav-link" aria-current="page" href="index.php?controller=homepageadmin&action=index">Trang chủ</a></div>
                    <div class="_sidebar-item"><a class="nav-link" aria-current="page" href="index.php?controller=introadmin&action=index">Giới thiệu</a></div>
                    <div class="_sidebar-item"><a class="nav-link" aria-current="page" href="index.php?controller=productadmin&action=index">Sản phẩm</a></div>
                    <div class="_sidebar-item"><a class="nav-link" aria-current="page" href="index.php?controller=postadmin&action=index">Tin tức</a></div>
                    <div class="_sidebar-item"><a class="nav-link" aria-current="page" href="index.php?controller=answerandquestionadmin&action=index">Hỏi đáp</a></div>
                    <div class="_sidebar-item"><a class="nav-link" aria-current="page" href="index.php?controller=contactadmin&action=index">Liên hệ</a></div>
                </div>
            </nav>
