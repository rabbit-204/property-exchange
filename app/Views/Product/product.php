        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3 filter-col position-relative">
                ...
                <select class="form-select" id="cityFilter">
                    <option value="All" <?= isset($_GET['city']) && $_GET['city'] === 'All' ? 'selected' : '' ?>>Tất cả
                    </option>
                    <option value="Hà Nội" <?= isset($_GET['city']) && $_GET['city'] === 'Hà Nội' ? 'selected' : '' ?>>Hà
                        Nội</option>
                    <option value="TP HCM" <?= isset($_GET['city']) && $_GET['city'] === 'TP HCM' ? 'selected' : '' ?>>TP
                        HCM</option>
                    <option value="Khác" <?= isset($_GET['city']) && $_GET['city'] === 'Khác' ? 'selected' : '' ?>>Khác
                    </option>
                </select>
            </div>
        ...
        <div class="row g-4">
            ...
            <?php if (!empty($products)): ?>
                <?php foreach ($products as $product): ?>
                    <div class="col-md-4">
                        <a href="index.php?controller=productdetail&action=index&id=<?= htmlspecialchars($product['id']) ?>"
                                    ...
                                    <div>
                                        ...
                                        <div class="property-footer d-flex justify-content-between align-items-center">
                                            <div class="text-white">
                                                ...
                                                <?= htmlspecialchars($product['bedrooms']) ?>
            ...
            <nav>
                <ul class="pagination justify-content-center">
                    ...
                    <?php if ($currentPage > 1): ?>
                        <li class="page-item">
                            <a class="page-link"
                                href="?<?= http_build_query(array_merge($queryParams, ['page' => $currentPage - 1])) ?>">Trước</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                        <li class="page-item <?= $i == $currentPage ? 'active' : '' ?>">
                            <a class="page-link"
                                href="?<?= http_build_query(array_merge($queryParams, ['page' => $i])) ?>"><?= $i ?></a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <?php if ($currentPage < $totalPages): ?>
                        <li class="page-item">
                            <a class="page-link"
                                href="?<?= http_build_query(array_merge($queryParams, ['page' => $currentPage + 1])) ?>">Tiếp</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </nav>
